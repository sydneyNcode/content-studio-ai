    ...
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, var(--color-background-primary) 0%, var(--color-background-secondary) 100%)' }}>
        <div style={{ padding: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '0.5px solid var(--color-border-tertiary)' }}>
          ...
          <button onClick={() => { setAppState('login'); }} style={{ background: 'var(--color-background-primary)', border: '0.5px solid var(--color-border-secondary)', borderRadius: 'var(--border-radius-lg)', padding: '10px 20px', cursor: 'pointer', fontSize: '14px', fontWeight: '500', color: 'var(--color-text-primary)' }}>
            Login
          </button>
        </div>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '4rem 2rem', textAlign: 'center' }}>
          ...
          <button onClick={() => setAppState('signup')} style={{ padding: '16px 40px', background: 'var(--color-background-primary)', border: '0.5px solid var(--color-border-secondary)', borderRadius: 'var(--border-radius-lg)', cursor: 'pointer', fontSize: '16px', fontWeight: '500', color: 'var(--color-text-primary)', marginBottom: '2rem' }}>
            Get Started Free
          </button>
      ...
      <div style={{ minHeight: '100vh', background: 'var(--color-background-secondary)', padding: '2rem' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            {[
              { name: 'Free', price: '$0', features: ['5 ideas/month', 'Basic dashboard', 'Community access'], current: userPlan === 'free' },
              { name: 'Pro', price: '$29', period: '/month', features: ['Unlimited ideas', 'Advanced analytics', 'AI writing assistant', 'Priority support'], recommended: true, current: userPlan === 'pro' },
              { name: 'Agency', price: '$99', period: '/month', features: ['Everything in Pro', 'Team seats (5)', 'Custom branding', 'API access'], current: userPlan === 'agency' }
            ].map((plan) => (
