    ...
    <div className="px-4 pt-6 pb-6">
      ...
      <div className="bg-white dark:bg-[#2A201A] border border-[#EDE8E3] dark:border-[#3A2E28] rounded-2xl p-5 mb-4">
        ...
        <textarea
          ...
          rows={4}
          style={{ fontSize: '16px' }}
          className="w-full bg-[#FAF8F5] dark:bg-[#18120F] border border-[#EDE8E3] dark:border-[#3A2E28] rounded-xl px-4 py-3 text-[#1A1008] dark:text-[#F0EBE5] placeholder-[#C0B4AC] focus:outline-none focus:border-[#8B1538] transition-colors resize-none mb-3"
        />
        <button
          onClick={saveBio}
          className={`w-full py-2.5 rounded-full text-sm font-medium transition-all ${saved ? 'bg-green-500 text-white' : 'bg-[#8B1538] text-[#FAF8F5] hover:bg-[#6b0f2b]'}`}
        >
